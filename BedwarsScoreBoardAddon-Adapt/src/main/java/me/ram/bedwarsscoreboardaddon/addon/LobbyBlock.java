...
public class LobbyBlock {
	...
	public LobbyBlock(Arena arena) {
		...
		if (!arenaConfig.getBoolean("lobby_block.enabled", Config.lobby_block_enabled)) {
			return;
		}
	...
	private void removeBlock(Location loc) {
		...
		ArenaConfig arenaConfig = arena.getArenaConfig();
		Location location1 = location.clone().add(
				arenaConfig.getInt("lobby_block.position.1.x", Config.lobby_block_position_1_x),
				arenaConfig.getInt("lobby_block.position.1.y", Config.lobby_block_position_1_y),
				arenaConfig.getInt("lobby_block.position.1.z", Config.lobby_block_position_1_z));
		Location location2 = location.clone().add(
				arenaConfig.getInt("lobby_block.position.2.x", Config.lobby_block_position_2_x),
				arenaConfig.getInt("lobby_block.position.2.y", Config.lobby_block_position_2_y),
				arenaConfig.getInt("lobby_block.position.2.z", Config.lobby_block_position_2_z));
