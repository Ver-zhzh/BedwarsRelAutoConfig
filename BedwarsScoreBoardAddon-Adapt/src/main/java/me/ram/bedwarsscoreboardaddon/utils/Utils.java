...
public class Utils {
	...
	public static void sendTitle(Player player, Player PlaceholderPlayer, Integer fadeIn, Integer stay, Integer fadeOut,
		...
		try {
			if (title != null) {
				title = ColorUtil.color(PlaceholderAPIUtil.setPlaceholders(PlaceholderPlayer, title));
			...
			if (subtitle != null) {
				subtitle = ColorUtil.color(PlaceholderAPIUtil.setPlaceholders(PlaceholderPlayer, subtitle));
				Object e = getNMSClass("PacketPlayOutTitle").getDeclaredClasses()[0].getField("TIMES").get(null);
