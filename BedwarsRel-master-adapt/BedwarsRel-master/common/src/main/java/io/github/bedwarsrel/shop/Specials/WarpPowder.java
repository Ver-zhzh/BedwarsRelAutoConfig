...
public class WarpPowder extends SpecialItem {
  ...
  public WarpPowder() {
    ...
    this.fullTeleportingTime = BedwarsRel.getInstance().getIntConfig("specials.warp-powder.teleport-time", 6);
  }
  ...
  public void cancelTeleport(boolean removeSpecial, boolean showMessage) {
    ...
    this.teleportingTime = (double) this.game.getGameConfig().getInt("specials.warp-powder.teleport-time", 6);
    ...
    if (showMessage) {
      this.player
          .sendMessage(ChatWriter
              .pluginMessage(this.game, BedwarsRel._l(this.player, "ingame.specials.warp-powder.cancelled")));
    }
  ...
  public void runTask() {
    ...
    this.player.sendMessage(
        ChatWriter.pluginMessage(this.game, BedwarsRel._l(this.player, "ingame.specials.warp-powder.start",
            ImmutableMap.of("time", String.valueOf(this.fullTeleportingTime)))));

    this.teleportingTask = new BukkitRunnable() {

      public String particle = WarpPowder.this.game.getGameConfig()
          .getString("specials.warp-powder.particle", "fireworksSpark");
      public boolean showParticle = WarpPowder.this.game.getGameConfig().getBoolean(
          "specials.warp-powder.show-particles",
          true);
