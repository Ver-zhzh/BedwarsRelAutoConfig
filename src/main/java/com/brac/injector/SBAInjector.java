    ...
    private boolean applyPendingConfigsWithAPI(String gameName, PendingGameConfig pending) {
        try {
            ...
            if (pending.mainConfig != null) {
                tempMainConfigFile = new File(Bukkit.getPluginManager().getPlugin("BedwarsRelAutoConfig").getDataFolder(),
            ...
            Boolean registerSuccess = (Boolean) registerMethod.invoke(null, gameName, tempMainConfigFile, tempTeamShopFile);
